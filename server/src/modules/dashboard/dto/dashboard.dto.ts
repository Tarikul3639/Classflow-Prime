...
export class DashboardUpdateDto {
  ...
  @ApiProperty({ enum: UpdateCategory }) category!: UpdateCategory;
  @ApiPropertyOptional() eventAt?: string | null;
  @ApiProperty({ type: [DashboardMaterialDto] }) materials!: DashboardMaterialDto[];
...
export class DashboardGroupDto {
  ...
  @ApiProperty({ enum: GroupPlatform }) platform!: GroupPlatform;
