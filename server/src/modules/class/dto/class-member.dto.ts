...
export class ClassMemberDto {
    ...
    @ApiProperty({ example: 'instructor', description: 'Role of the member in the class', enum: EnrollmentRole })
...
export class GetClassMembersResponseWrapperDto {
    ...
    @ApiProperty({ type: GetClassMembersResponseDto, description: 'Data containing class members' })
    data: GetClassMembersResponseDto;
}

export class AssignAssistantRequestDto {
    @ApiProperty({ example: '12345', description: 'Unique identifier of the member to be assigned as assistant' })
    @IsString()
...
export class AssignAssistantResponseDto {
    ...
    @ApiProperty({ type: AssignAssistantRequestDto, description: 'Data containing the user ID of the assigned assistant' })
    data: {
        userId: string;
    };
}
...
export class RevokeAssistantRequestDto {
    @ApiProperty({ example: '12345', description: 'Unique identifier of the member to have assistant role revoked' })
    @IsString()
    @IsNotEmpty({ message: 'User ID is required' })
    userId: string;
}
...
export class RevokeAssistantResponseDto {
    ...
    @ApiProperty({ type: AssignAssistantRequestDto, description: 'Data containing the user ID of the revoked assistant' })
    data: {
        userId: string;
    };
}
...
export class RevokeMemberResponseDto {
    ...
    @ApiProperty({ type: AssignAssistantRequestDto, description: 'Data containing the user ID of the revoked member' })
    data: {
        userId: string;
    };
}